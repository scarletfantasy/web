...
public class securityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .and()
                .authorizeRequests()
                .antMatchers("/jpalogin","/sslogin","/jpabooklist","/jparegister","/img/*","/jpacurrentuser","/test","/getdetail").permitAll()
                .antMatchers("/jpashowcart","/jpacleancart","/jpaaddtocart","/jpashowhistory","/jpadeleteorder").hasAnyAuthority("USER","ADMIN")
                .antMatchers("/jpaeditsave","/jpaeditdelete","/jpashowuser","/uploadimg").hasAuthority("ADMIN")
